...
static const QString c_HelpWindowMessageString          {
                                                             ...
                                                             "\n12) There is also an interactive mode for adding and removing word pieces to/from input: \n"
                                                             " - click S to enter Selection mode. Navigate with the left/right arrows until the required piece "
                                                             "is selected. Then click the down arrow to add it to the first word or up to add it to the second word.\n"
                                                             " - click 1 or 2 to determine from which input word pieces should be removed. Last piece is selected. To select "
                                                             "more pieces navigate with left arrow. To select less pieces use the right arrow. Hit ENTER/RETURN once ready.\n"
                                                             " - to cancel the interactive mode click the same entry key (e.g. S) again.\n"
                                                             " - to change the cursor area/sub-mode hit the key for the required area/sub-mode (e.g. if you are in selection "
                                                             "(previously hit S) and wish to remove one or more pieces from second input word just hit 2).\n"
                                                             "\n13) The interactive mode for adding/removing pieces is exited in following cases:\n"
                                                             " - when selecting or deleting one or more word pieces to/from input by mouse click\n"
                                                             " - when hovering with the mouse over the input word pieces\n"
                                                             " - when a new pair of words is loaded\n"
                                                             " - when cancelled by user (see previous point)\n"
