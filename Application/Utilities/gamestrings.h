...
static const QString c_RawGameHelpMessage                   {
                                                                 ...
                                                                 "The language can then be changed from the main game dialog. If the language contains no word pairs "
                                                                 "use the the data entry dialog to add data to it. In main game menu it is not possible to "
                                                                 "switch to a language that doesn't contain any valid pairs. Consult the data entry help for more details.\n"
                                                                 ...
                                                                 "Only a contiguous chunk of pieces (ending with the last piece from the input area of the word) can be erased. "
                                                                 "When hovering with the mouse on the first piece to be deleted the chunk "
                                                                 "is highlighted with brown color as marked for deletion.\n"
                                                                 "\n11) For removing all input pieces at once please press the Clear input button. Also for "
                                                                 "removing entire individual word inputs use the shortcuts ALT+4 for the first word word input and ALT+5 for "
                                                                 "the second.\n"
                                                                 ...
                                                                 " - In the mixed pieces container navigate with the left/right arrows until the required piece "
                                                                 "is selected. Then click the down arrow to add it to the first word input (located below mixed pieces container) or up "
                                                                 "to add it to the second word (located above).\n"
                                                                 " - when entering an input container last piece is selected. To select more pieces navigate with the left arrow. "
                                                                 ...
                                                                 " - the cursor can be moved in a circular fashion within the mixed pieces container and left/right in the "
                                                                 "input containers.\n"
                                                                 " - the cursor position within the mixed pieces container is updated to the first available start piece if this is "
                                                                 "the only valid piece type to be added to input in the current state.\n"
                                                                 " - if one word has already been completed, the cursor moves to an available middle-piece each time a new part is added to input "
                                                                 "unless the only remaining part to be added is the end piece.\n"
                                                                 ...
                                                                 "is more than one piece left to be added to input\n"
                                                                 "\n16) After building the two words, press Submit for validating input.\n"
                                                                 "\n17) If the input is not the right one, the user will be asked "
                                                                 "to re-enter the words. Use the chunk delete functionality mentioned above to return the chosen pieces to mixed area"
                                                                 "and then re-add them to input to get the correct result. Press Submit again once finished.\n"
                                                                 ...
                                                                 "if the Show results button is pressed or when the level or language are changed.\n"
                                                                 ...
                                                                 "a new pair of words is provided to user for guessing without having the level or language changed. "
                                                                 "When the level or language are changed all data from the statistics bar (except time limit) remain constant. \n"
                                                                 ...
                                                                 "easy/medium/hard.\n"
                                                                 "\n34) It is possible to setup a time limit for guessing each word pair. This means the user should enter the "
                                                                 ...
                                                                 "\n35) Following should be taken into consideration when setting up a time limit: \n"
                                                                 " - after enabling the time limit from intro pane the counter will start once entering the main pane\n"
                                                                 " - at timeout a new pair is provided to user but no points are earned (same as when requesting the result"
                                                                 " to be shown by hitting ALT+B). The countdown is restarted.\n"
                                                                 " - the counter starts/stops immediately after time limit has been enabled/disabled from main pane\n"
                                                                 " - the counter pauses when temporarily leaving the main pane (to help or data entry dialogs) and resumes once "
                                                                 "returning to game\n"
                                                                 ...
                                                                 "Press the Enter new pairs button or hit ALT+E to access the menu. "
                                                                 "For more details please access the Help section from the data entry dialog. \n"
                                                                 "\n37) The data entry menu is available only after setting a language at game start no matter if it contains valid data or not.\n"
                                                                 "\n38) Press Quit or hit ALT+Q for exiting the application. Please note that if data saving or loading "
                                                                 "are in progress the exit process will take place only after the load or save operation is complete. "
                                                                 "Please refer to the data entry help menu for more details regarding closing the application from data entry dialog."
