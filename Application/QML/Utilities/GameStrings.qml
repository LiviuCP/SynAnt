...
QtObject {
    ...
    readonly property string languageSelectionToolTip:                              "Click or hit ALT+L to choose the language you wish the retrieved word pairs to have."
    readonly property string dataEntryLanguageSelectionToolTip:                     "Click or hit ALT+L to choose the language in which you wish to enter new word pairs."
}
